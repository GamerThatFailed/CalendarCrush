      ...
      <div className="space-y-4">
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">Clear your schedule by cancelling all meetings using the ball!</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            <h3 className="font-semibold text-gray-800">Power-ups</h3>
            <p className="text-gray-600 text-sm">Collect office-themed power-ups for special abilities</p>
          </div>
        </div>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">Different meeting types give different points</p>
          </div>
        </div>
      </div>
